...
namespace Hasad
{
    public partial class InventpryAdjsAddNew : Form
    {
        private const string strconneciton = @"Data Source=PC;Initial Catalog=Hasad;Integrated Security=True";
        SqlConnection con = new SqlConnection(strconneciton);
        SqlCommand cmd = new SqlCommand();

        public InventpryAdjsAddNew()
        {
            InitializeComponent();
            fillComboBoxStoreInfo();
        }

       void fillComboBoxStoreInfo()
        {
            ...
            try
            {
                ...
                while (sqlReader.Read())
                {
                    ...
                    comboBoxStoreInfoAIAN.Items.Add(col);
